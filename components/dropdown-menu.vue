...
defineProps({
  onEdit: Function,
  onDelete: Function,
  data: Object, // Receive the data object for each table row
});
...
<div class="relative" ref="dropdownRef">
    ...
    >
        <button
            @click="() => { onEdit(data); isOpen = false; }"
            class="flex items-center px-4 py-2 w-full text-blue-600 hover:bg-gray-100"
        >
            <icon name="uil:edit" />
